  ...
  return (
    <section id="gallery" className="py-20">
      <div className="container px-2">
        <h2 className="sm:text-5xl text-4xl font-medium mb-6 text-center px-2">
          Работы наших мастеров
        </h2>
        <WorksGallery />
        {/* <div className="text-center anim-from-bottom anim-delay">
          <h3 className="lg:text-4xl text-3xl font-medium mt-6 mb-3">
          ...
          <a
            ...
            target="_blank"
          >
            <i className="fa-brands fa-instagram"></i> manhattan.bb
          </a>
        </div> */}
      </div>
    </section>
